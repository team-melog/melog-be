...
--
-- Name: flyway_schema_history; Type: TABLE; Schema: melog; Owner: melog
--

CREATE TABLE melog.flyway_schema_history (
...
ALTER TABLE melog.flyway_schema_history OWNER TO melog;
...
--
-- Name: flyway_schema_history flyway_schema_history_pk; Type: CONSTRAINT; Schema: melog; Owner: melog
--

ALTER TABLE ONLY melog.flyway_schema_history
...
--
-- Name: flyway_schema_history_s_idx; Type: INDEX; Schema: melog; Owner: melog
--

CREATE INDEX flyway_schema_history_s_idx ON melog.flyway_schema_history USING btree (success);
